...
>
  <motion.h1 
    ...
    className="text-5xl md:text-7xl font-bold text-[#4a3728] leading-[1] mb-6 tracking-tight"
  >
    Baked Daily, <br />
    <span className="text-[#d87a7a] font-light">With Absolute Care.</span>
  </motion.h1>
  ...
  <motion.p 
    ...
    className="text-[#4a3728]/80 font-normal text-lg md:text-xl max-w-md mx-auto md:mr-0 mb-8 leading-relaxed"
  >
  ...
  >
    <button className="border border-[#4a3728] text-[#4a3728] px-10 py-3 font-semibold uppercase tracking-widest hover:bg-[#4a3728] hover:text-white transition-all duration-300">
      Explore Menu
    </button>
  </motion.div>
</motion.div>
