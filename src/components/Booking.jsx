...
function Booking() {
  ...
  const handleWhatsAppSubmit = () => {
    const phoneNumber = "601126913096";
    const message = `*New Booking Request*%0A%0A` +
                    `*Name:* ${formData.name}%0A` +
                    `*Service:* ${formData.service}%0A` +
                    `*Quantity:* ${formData.units} units%0A` +
  ...
  return (
    <section className="relative w-full py-20 px-6 bg-white text-left overflow-hidden">
      ...
      <div className="absolute -top-20 -right-60 md:-top-10 md:-right-80 z-0 opacity-100">
        <svg viewBox="0 0 900 600" width="1000" height="1000" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="absolute -top-120 -left-90 z-0 opacity-100">
        <svg viewBox="0 0 900 600" width="800" height="800" xmlns="http://www.w3.org/2000/svg">
